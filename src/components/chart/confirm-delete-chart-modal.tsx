...
interface ConfirmDeleteChartModalProps {
  isOpen: boolean
  chartId: number | null
  chartName: string
  onClose: () => void
...
export function ConfirmDeleteChartModal({
  isOpen,
  chartId,
  chartName,
  onClose,
  onConfirm,
}: ConfirmDeleteChartModalProps) {
      ...
      <div className="w-full max-w-md rounded-lg bg-white dark:bg-gray-800 p-6 shadow-xl">
        ...
        <div className="mb-6">
          <p className="text-gray-700 dark:text-gray-300">
            Bạn có chắc chắn muốn xóa biểu đồ <span className="font-semibold">{chartName}</span>?
          </p>
